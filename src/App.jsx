...
export default function App() {
  ...
  const mapDbToReport = (db) => ({
    ...
    email: db.email || '',
    dni: db.dni || '',
    deviceInfo: db.device_info || 'Desconocido',
  ...
  const mapReportToDb = (rep) => ({
    ...
    dni: rep.dni || null,
    device_info: rep.deviceInfo || null,
  ...
  const handleAddReport = async (newReportData) => {
    const newReport = {
      ...
      email: newReportData.email || null,
      dni: newReportData.dni || null,
      deviceInfo: newReportData.deviceInfo || 'Desconocido',
