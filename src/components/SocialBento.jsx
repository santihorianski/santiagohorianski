    ...
    <section className="bento-section" style={{ padding: hideHeader ? '2rem 0 6rem' : '6rem 0', background: hideHeader ? 'transparent' : 'var(--bg-dark)' }}>
      <div className="container">
        ...
        <div className="bento-grid">
          ...
          <a href="https://wa.me/5493765383604?text=Hola%20Santiago%2C%20estuve%20viendo%20tu%20sitio%20y%20me%20gustar%C3%ADa%20contactarme." className="bento-card bento-wsp glass-panel" target="_blank" rel="noreferrer">
